...
function Draw(dataa, id, timeFormat, tmed) {
  ...
  svg
    ...
    .attr('y1', y(tmed - 0.05 * tmed)) //start of the line
    .attr('x2', x(data[data.length - 10].date))
    .attr('y2', y(tmed - 0.05 * tmed));
