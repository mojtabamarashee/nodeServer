...
function GetMarketInit() {
  ...
  //console.log('allRows = ', allRows[5]);
  allRows.map((v, i) =>
    file1.write(
      '{inscode : "' + v.inscode + '", name : "' + v.name + '"}' + '\n',
    ),
  );
  console.log('finish');
}
...
GetMarketInit();
setInterval(GetMarketInit, 30 * 60 * 1000);
...
app.get('/:name', (req, res) => {
  //MongoClient.connect(
  res.send(FindPClosing(req.params.name));
});
